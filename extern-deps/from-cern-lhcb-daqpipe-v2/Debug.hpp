...
#else
	#define DAQ_DEBUG_ARG(cat,x) (DAQ::Debug::isDisabled())?false:DAQ::Debug(x,DAQ_CODE_LOCATION,DAQ::MESSAGE_DEBUG,cat)
#endif
...
**/
#define assumeArg(check,format) (check)?true:DAQ_FATAL_ARG(format)
